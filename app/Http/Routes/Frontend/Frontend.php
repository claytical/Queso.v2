...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['namespace' => 'User'], function() {
        ...
        Route::get('quests/history/{course_id}', 'QuestController@history')->name('quests.history');
...
//        Route::get('grade/link/{link_id}', 'GradeController@link')->name('grade.link');
        ...
        Route::get('grade/activity/select/{course_id}', 'GradeController@activity_select')->name('grade.activity.select');
...
//        Route::get('manage/quest/create', 'QuestController@create_form')->name('quests.create.begin');
        ...
        Route::get('manage/teams/course/{course_id}', 'CourseController@manage_teams')->name('course.manage.teams');
