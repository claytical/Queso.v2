                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Login</div>
                        ...
                        {{ Form::open(['route' => 'auth.login', 'class' => 'form-horizontal']) }}
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    {{ Form::submit(trans('labels.frontend.auth.login_button'), ['class' => 'btn btn-primary btn-block']) }}

                                </div><!--col-md-6-->
                            </div><!--form-group-->
                                    {{ link_to('password/reset', trans('labels.frontend.passwords.forgot_password', ['class' => 'pull-right'])) }}
