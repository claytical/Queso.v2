        ...
        <h4>Feedback to Student</h4>
            ...
            <div class="col-lg-3">
                  <div class="form-group">
                    <label for="skill1" class="col-sm-6 control-label">Skill #1</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="skill2" class="col-sm-6 control-label">Skill #2</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="skill3" class="col-sm-6 control-label">Skill #3</label>
                    <div class="col-sm-6">
