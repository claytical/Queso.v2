...
function showResponse(responseText, statusText, xhr, $form)  { 
    ...
    $('#skills').append("<div class='row'>" + responseText.name + "<form method='POST' action='{!! route('course.remove.skill') !!}'>"+token.html()+"<input name='skill' type='hidden' value='" + responseText.id + "'><input class='btn btn-danger btn-xs pull-right' type='submit' value='Remove'></form></div>");
